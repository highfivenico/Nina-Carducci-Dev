(function ($) {
  ...
  $.fn.mauGallery.listeners = function (options) {
    ...
    // Click au clavier avec Enter ou Espace
    $(".gallery").on("keydown", ".mg-prev, .mg-next", (e) => {
    ...
    // Navigation au clavier dans le carousel modal
    $(document).on("keydown", (e) => {
      // Vérification que la modale est ouverte
      const modalIsVisible = $(".modal").length > 0;
